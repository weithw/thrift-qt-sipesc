...
**
** Created: Wed Jul 22 10:54:00 2015
...
static const char qt_meta_stringdata_TaskManager[] = {
    "TaskManager\0\0newTaskAdded(qint32)\0"
    "onTaskDone(ID)\0"
};
...
void TaskManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->newTaskAdded((*reinterpret_cast< qint32(*)>(_a[1]))); break;
        case 1: _t->onTaskDone((*reinterpret_cast< ID(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject TaskManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TaskManager,
...
void *TaskManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "TaskListener"))
        return static_cast< TaskListener*>(const_cast< TaskManager*>(this));
...
// SIGNAL 0
void TaskManager::newTaskAdded(qint32 _t1)
{
